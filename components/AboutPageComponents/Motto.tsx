...
const Motto = () => {
  return (
    <>
      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-center items-center  space-y-6 md:space-y-0 md:space-x-20 leading-6 mb-40 text-center md:text-left">
