...
const PerformanceStats = () => {
  return (
    <>
      <div className="p-4 sm:p-10 lg:p-20  flex items-center justify-center mt-[100px]">
        <NeonGradientCard>
          <div className=" w-full  bg-[#333333] rounded-lg space-y-8 sm:space-y-12 shadow-2xl overflow-hidden p-6 sm:p-12 lg:p-20 text-center">
