...
export const allBlogs = [bestPracticesForWritingCleanAndMaintainableCode__indexMdx, buildingProgressiveWebAppsBridgingTheGapBetweenWebAndMobile__indexMdx, jsFrameworksComparison__indexMdx, mindfulnessAndMeditationTechniquesForDevelopersImprovingFocusAndClarity__indexMdx, masteringCssGridLayout__indexMdx, progressiveWebAppsPwa__indexMdx, restfulApisBuildingBlocks__indexMdx, automatingRepetitiveTasksProductivityHacksForDevelopers__indexMdx, webAccessibilityBestPractices__indexMdx, webAccessibilityInclusiveDesign__indexMdx, webDevelopmentToolsProductivity__indexMdx]
